...
## Version 0.3.1 (2026-03-27)

### ✨ 新特性
- 🔄 Manager 前端从 React 迁移到 Vue，与 Member 模块统一技术栈
- 🧪 BDD 测试覆盖率提升至 49.6%

### 🐛 Bug 修复
- 🛠️ 修复 BDD 测试套件清理问题 (#80)
- 🚀 修复集成测试工作流中的服务器启动问题
- 🔧 修复覆盖率摘要中的 broken pipe 错误
- 🛠️ 修复集成服务器构建中的 SIGPIPE 信号处理

### 📦 依赖更新
- 🔄 oapi-codegen/runtime: 升级至最新版本 (#66)
